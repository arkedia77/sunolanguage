...
- [sunolanguage] **★N017 배치 10곡 생성+적재+생성요청 (drift 0.5 응집성, Leo 지정)** — SP엔진수정 적용 첫 배치. audit **PASS**(coh 0.605 저-coh0, 폼10종, 키 9/10·BPM 7/10 genre직후 안착, 누출0/1행0/V1=V2 0, 브래킷85%). DB-direct **gid 30091~30100**(누적 180곡). sunomusic 생성요청 발송. ★교훈: 반복 `--save` 테스트가 exclude-history 풀 고갈→1행/누출 폴백 연쇄 유발, 테스트배치는 즉시 정리할 것. `data/lyrics_history/lyrics_batch_20260619_164857.json` — 2026-06-19 ✅
