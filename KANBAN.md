...
- [sunolanguage] **Wave T entity** — 1차분 발송 완료(06-10): GT 트로트 12곡 4값 세트 + 앵커 SP(gid20010) + 치환표 GT diff 3건. **★2차분 발송 완료(2026-06-15, `ba7ab144`)**: 신규 Trot 서브장르 시그니처 5종(City Pop/R&B/Synth/Trap=ready + Latin=provisional, GT-attested, `data/wave_t/wave_t_2_subgenre_signatures.json`) — leomusic-trot `_future_genres` 명시 대기분(City Pop Trot/R&B Trot) 해소. **+ ★공유 canon `kkeokk_ki` 치환 diff**: match_patterns(kkeokk/note-bending 등) 전 Trot 엔트리 공유인데 Suno corpus 전건 0건 → 검출기 100% false-negative 발견, slides/heavy vibrato/traditional phrasing로 치환 권고(치환표 공동관리 의무 이행). **회신 대기: canon 치환 수락·5종 등재 피드백·Latin provisional 동의**
