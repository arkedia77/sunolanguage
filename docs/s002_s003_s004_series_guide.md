...
sunolanguage 코퍼스 분석에서 흥미로운 패턴이 발견되었다. Suno는 음악을 묘사할 때 "key of D major"(652회)처럼 조성은 구체적으로 말하지만, "sforzando"나 "pianississimo" 같은 다이내믹 마킹은 단 한 번도 사용하지 않았다. 코드 진행(chord progression)도 0회, 구체적인 코드명도 0회.
