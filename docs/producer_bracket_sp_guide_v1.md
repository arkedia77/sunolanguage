...
**날짜** 2026-08-27 (★08-28 §6-1 갱신 — uptake 편입) · **작성** sunolanguage · **근거** 우리 코퍼스 540곡 · **입력↔출력 짝 411**
...
1. ~~**「브라켓이 먹힌다」고는 말하지 않았습니다.** 잰 것은 「**안 불린다**」뿐입니다.~~
   ...
   **실제 무가창 길이 중앙 2.86배**(범위 0.23~5.34). **짧게 지시할수록 더 벗어납니다**(4bar 지시 3.06~5.34배 ↔
   8bar 지시 1.55~2.66배 — 하한이 있는 것처럼 움직입니다). ⇒ ★**길게 쓰는 것과 길이를 지시하는 것은 다른 축입니다.**
   **서술을 늘리는 건 안전하고(§1-⑶), 숫자로 지시하는 건 안 먹힙니다.**
