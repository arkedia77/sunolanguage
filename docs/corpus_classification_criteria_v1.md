...
**작성일**: 2026-07-31 (3시간 재검토 세션 산출물) · **개정**: 2026-08-13 v1.1(§11 외부 근거 등급 대장 신설)
...
|---|---|---|---|---|
| `(spoken)` 괄호 = 해당 행을 말로 | **입력층** | LEO 실청취 4/4(Dead Budget 04-25) + 기계 RM2 견고·RM1 불가 | **A** | 「기계는 2클립 중 1클립만 견고. **N=2**. 나머지는 대조군 종속」 |
